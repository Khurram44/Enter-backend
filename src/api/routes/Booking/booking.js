...
router.get('/RejectedId/:user_id', UserController.getbookingByCatIDRejected)
...
// router.put('/update/:order_no', UserController.Confirmbooking)
...
router.put('/confirm/:order_no', UserController.Confirmbooking)
